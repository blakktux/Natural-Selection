 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Zachary Maciejewski");
		  toPrint += p1.toString("zmaciejewski");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Sriram Ganesan");
		  toPrint += p2.toString("sganesan34");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Ho Keun Kim");
		  toPrint += p3.toString("hkim751");
